...
keys_to_remove = %w[jc_effect_add_blunt_damage_desc jc_effect_add_blunt_damage_desc_detail jc_effect_add_spirit_damage_desc jc_effect_add_spirit_damage_desc_detail jc_effect_add_pierce_damage_desc jc_effect_add_pierce_damage_desc_detail jc_effect_add_slash_damage_desc jc_effect_add_slash_damage_desc_detail jc_effect_add_lightning_damage_desc jc_effect_add_lightning_damage_desc_detail jc_effect_add_pickaxe_damage_desc jc_effect_add_pickaxe_damage_desc_detail jc_effect_add_chop_damage_desc jc_effect_add_chop_damage_desc_detail jc_effect_expert_brawler_desc_detail jc_effect_expert_acrobat_desc_detail jc_effect_expert_daggers_desc_detail jc_effect_expert_smasher_desc_detail jc_effect_expert_spearmaiden_desc_detail jc_effect_expert_sprinter_desc_detail jc_effect_expert_axemaster_desc_detail jc_effect_expert_fisher_desc_detail jc_effect_expert_polearms_desc_detail jc_effect_expert_swordsman_desc_detail]
